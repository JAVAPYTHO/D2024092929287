...
def plot_combined_figure_1(files):
    ...
    sns.scatterplot(ax=axs[0, 0], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='viridis', s=70, edgecolor='w', alpha=0.85, legend=False)
    ...
    sns.scatterplot(ax=axs[0, 1], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='plasma', s=70, edgecolor='w', alpha=0.85, legend=False)
    ...
    sns.scatterplot(ax=axs[1, 0], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='inferno', s=70, edgecolor='w', alpha=0.85, legend=False)
    ...
    sns.scatterplot(ax=axs[1, 1], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='magma', s=70, edgecolor='w', alpha=0.85, legend=False)
...
def plot_combined_figure_2(files):
    ...
    df = load_data(files[0])
    sns.scatterplot(ax=axs[0, 0], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='magma', s=70, edgecolor='w', alpha=0.85, legend=False)
    ...
    df = load_data(files[1])
    sns.scatterplot(ax=axs[0, 1], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='magma', s=70, edgecolor='w', alpha=0.85, legend=False)
    ...
    df = load_data(files[2])
    sns.scatterplot(ax=axs[1, 0], data=df, x='lon_gcj02', y='lat_gcj02', hue='type', palette='magma', s=70, edgecolor='w', alpha=0.85, legend=False)
...
plot_combined_figure_2([
    'F:\\pythonProject\\python\\question2/Appendix 3/Business-residential data.csv',
    'F:\\pythonProject\\python\\question2/Appendix 3/Accommodation service data.csv',
    'F:\\pythonProject\\python\\question2/Appendix 3/Government and social organizations data.csv',
    'F:\\pythonProject\\python\\question2/Appendix 3/Food and beverage service data.csv'
])
